...
import com.mycompany.myapp.MyLibApp;
...
@SpringBootTest(classes = MyLibApp.class)
public class BookResourceIntTest {
    ...
    public void setup() {
        ...
        final BookResource bookResource = new BookResource(bookRepository, bookSearchRepository);
